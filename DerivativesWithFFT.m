...
dx=x(2)-x(2)  %dx value needed for finite difference
...
figure(1),plot(x,u,'r',x,u1,'g',x,u1exact,'go',x,u2,'b',x,u2exact,'bo') ;
figure(2),subplot(3,1,1), plot(x,u1exact,'ks-',x,u1,'k',x,ux,'ko',x,ux2,'k*') ;
